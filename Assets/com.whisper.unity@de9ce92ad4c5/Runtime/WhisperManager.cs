...
namespace Whisper
{
    public delegate void OnVoiceRecognizedDelegate(string text);
    ...
    public class WhisperManager : MonoBehaviour
    {
        ...
        private string modelPath = "ggml-small.en.bin";
        ...
        /// <summary>
        /// Raised when whisper transcribed a new text segment.
        /// Provides the transcribed text as a simple string.
        /// </summary>
        public event OnVoiceRecognizedDelegate OnVoiceRecognized;
        ...
        private void OnNewSegmentHandler(WhisperSegment segment)
        {
            _dispatcher.Execute(() =>
            {
                ...
                OnVoiceRecognized?.Invoke(segment.Text);
            });
        }
